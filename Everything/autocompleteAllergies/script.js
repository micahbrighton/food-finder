$(function () {
  function autocomplete(inp2, arr2) {
    ...
    inp2.addEventListener("input2", function (e) {
      ...
      for (i = 0; i < arr2.length; i++) {
        ...
        if (arr2[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          b.addEventListener("click", function (e) {
            ...
            inp2.value = this.getElementsByTagName("input2")[0].value;
  ...
  autocomplete(document.getElementById("myInput2"), ingreds);
  $.ajax({

    url: 'https://api.spoonacular.com/food/ingredients/autocomplete?query=' + document.getElementById("myInput2") + '&number=5&apiKey=128541af6bef438a808dc04669c8f556',
